...
import {
  PurchaseOrderVendorDeliveryReceivedKey,
  PurchaseOrderVendorDocumentKey,
...
interface NotesVendorDeliveryProofModalProps {
  title?: string;
  confirmText?: string;
  cancelText?: string;
  ...
  handlePrint?: (params: PurchaseOrderVendorDeliveryReceivedKey) => void;
  showIcon?: boolean;
}

export const NotesVendorDeliveryProofModal: React.FC<
  NotesVendorDeliveryProofModalProps
> = ({
  title,
  confirmText,
  cancelText,
  ...
  const handleSubmit = () => {
    if (handlePrint) {
      handlePrint({
        ...
        purchase_order_vendor_delivery_id: purchase_order_vendor_delivery_id,
