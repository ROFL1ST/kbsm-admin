...
export default function FinanceInPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="text-3xl font-bold text-foreground">Uang Masuk</h1>
          <p className="text-muted-foreground">
            Kelola pemasukan dan revenue perusahaan
          </p>
        </div>
        <Button
          onClick={() => {
            navigate("/finance-in/create", {
              state: {
                type: "INCOME",
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-primary">
              {formatIDR(header?.total_income_confirm)}
            </div>
          </CardContent>
        </Card>
        <Card>
      ...
      <Card>
        <CardHeader className="space-y-5">
          <CardTitle>Daftar Transaksi Masuk</CardTitle>
        </CardHeader>
        <CardContent>
