...
export default function ProductDistributions() {
  ...
  const fetchProductDistributions = async (params: ProductDistributionsKey) => {
    try {
      await getProductDistributions(params);
    } catch (error) {
    ...
    <div className="space-y-6">
      ...
      <Card className="border-primary/20">
        <CardHeader className="pb-2">
          <CardTitle>Filter Distribusi Produk</CardTitle>
        </CardHeader>
        <CardContent>
            ...
            {distributionData.length > 0 ? (
              <div className="space-y-4 p-4">
                {distributionData.map((product, index) => (
                  <Card
                    key={index}
                    className="hover:shadow-lg transition-all duration-300 border-primary/20 hover:border-primary/40 bg-gradient-to-br from-white to-primary/5 w-full"
                  >
                      ...
                      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                        ...
                        <div className="flex-shrink-0">
                          <Button
                            variant="outline"
                            size="sm"
                            className="border-primary/20 text-primary hover:bg-primary hover:text-white transition-colors w-full lg:w-auto"
                          >
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-400 mb-4">
                  Tidak ditemukan data distribusi produk
                </p>
              </div>
            )}
