  ...
  const fetchPurchaseOrderClient = async (params) => {
    try {
      const { data } = await API.get(
        `/purchase-order/vendors?page=${params.page}&size=${params.size}&type=1&progress_type_code=&status_trx_code=${params.status_trx_code}&search=${params.search}&payment_method_code=${params.payment_method_code}&start_date=${params.start_date}&end_date=${params.end_date}`,
      );
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            pesanan yang akan masuk stok gudang
          </p>
        </div>
      </div>
          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-col md:flex-row gap-4 w-full">
              ...
              <div className="relative flex-1">
                ...
                <Input
                  placeholder="Cari Vendor atau Kode Order..."
                    ...
                    <TableRow key={user.id}>
                      ...
                      <TableCell>
                        <div className="flex items-center gap-2">
                          <Button
                            onClick={() =>
                              navigate(`/incoming/loading/detail`, {
                                state: user?.id,
                              })
                            }
                            variant="ghost"
